...
def sig_hat_1_k_calc(mu_hat_1_k_min_1):                           # est variance first level
        sig_hat_1 = (mu_hat_1_k_min_1)*(1- mu_hat_1_k_min_1)
        # double check subtraction, 2 or 1?  #
        return sig_hat_1


def sig_hat_2_k_calc (sig_2_k_min_1,  mu_3_k_min_1, ka, om):      #est variance, second level
...
def sig_2_k_calc(sig_hat_2_k, sig_hat_1_k):                     #"actual" variance 2nd level
