...
# function for multiplying an array- essentially for the naive bayes multiplication
...
# subtracts the value of one of the weighted samples from the "comparison"
# value, if that new value is less than 0, (the weighted value was greater
# than the adjusted random value)
# return that most recent weighted value?
# double check the intuitions on this...
...
# gibbs sample for two qunatities
...
# class for generating objects with the features and their weights relative
# to the category
